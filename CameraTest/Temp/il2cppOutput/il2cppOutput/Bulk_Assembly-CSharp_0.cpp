...
extern const uint32_t CameraManager_RotateByKey_m3163743122_MetadataUsageId;
extern RuntimeClass* Quaternion_t2301928331_il2cpp_TypeInfo_var;
extern const uint32_t CameraManager_RotateByGyro_m3041920070_MetadataUsageId;
...
// System.Void CameraManager::RotateByGyro()
extern "C"  void CameraManager_RotateByGyro_m3041920070 (CameraManager_t3272490737 * __this, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
extern "C"  void CameraManager_Start_m229022957 (CameraManager_t3272490737 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		__this->set_firstCameraQuaternion_2(L_2);
		// }
		return;
	}
}
...
{
	{
		// RotateByGyro();
		// RotateByGyro();
		CameraManager_RotateByGyro_m3041920070(__this, /*hidden argument*/NULL);
		// }
		return;
	}
}
// System.Void CameraManager::RotateByKey()
extern "C"  void CameraManager_RotateByKey_m3163743122 (CameraManager_t3272490737 * __this, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (CameraManager_RotateByKey_m3163743122_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
	...
	}
	{
		...
		// this.transform.Rotate(0,-50 * Time.deltaTime,0);
		NullCheck(L_1);
		Transform_Rotate_m3172098886(L_1, (0.0f), ((float)il2cpp_codegen_multiply((float)(-50.0f), (float)L_2)), (0.0f), /*hidden argument*/NULL);
	}
...
IL_002f:
	{
		...
		// if(Input.GetKey(KeyCode.D)) {
		IL2CPP_RUNTIME_CLASS_INIT(Input_t1431474628_il2cpp_TypeInfo_var);
		bool L_3 = Input_GetKey_m3736388334(NULL /*static, unused*/, ((int32_t)100), /*hidden argument*/NULL);
		if (!L_3)
		{
			goto IL_005d;
		}
	}
	{
		...
		// this.transform.Rotate(0,50 * Time.deltaTime,0);
		NullCheck(L_4);
		Transform_Rotate_m3172098886(L_4, (0.0f), ((float)il2cpp_codegen_multiply((float)(50.0f), (float)L_5)), (0.0f), /*hidden argument*/NULL);
	}
...
// System.Void CameraManager::RotateByGyro()
extern "C"  void CameraManager_RotateByGyro_m3041920070 (CameraManager_t3272490737 * __this, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (CameraManager_RotateByGyro_m3041920070_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	memset(&V_1, 0, sizeof(V_1));
	{
		...
		Quaternion_t2301928331 * L_10 = __this->get_address_of_firstCameraQuaternion_2();
		float L_11 = L_10->get_x_0();
		float L_12 = (&V_1)->get_y_1();
		Quaternion_t2301928331 * L_13 = __this->get_address_of_firstCameraQuaternion_2();
		float L_14 = L_13->get_z_2();
		float L_15 = (&V_1)->get_w_3();
		// this.transform.rotation = new Quaternion(firstCameraQuaternion.x, gyroQuaternion.y, firstCameraQuaternion.z, gyroQuaternion.w);
		Quaternion_t2301928331  L_16;
		memset(&L_16, 0, sizeof(L_16));
		Quaternion__ctor_m435141806((&L_16), L_11, L_12, L_14, L_15, /*hidden argument*/NULL);
		// this.transform.rotation = new Quaternion(firstCameraQuaternion.x, gyroQuaternion.y, firstCameraQuaternion.z, gyroQuaternion.w);
		NullCheck(L_9);
		Transform_set_rotation_m3524318132(L_9, L_16, /*hidden argument*/NULL);
		// }
		return;
	}
}
